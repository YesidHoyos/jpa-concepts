package com.yesid.concepts.jdbc.simplecrud.repository;
...
import com.yesid.concepts.jdbc.simplecrud.mapper.PersonRowMapper;
...
public class PersonRepositoryJDBC {
	...
	public int update(Person person) {
		return jdbcTemplate.update("update person " + " set name = ?, location = ?, birth_date = ? " + " where id = ?",
				new Object[] { person.getName(), person.getLocation(), Date.valueOf(person.getBirthDate()),
						person.getId() });
	}
}
